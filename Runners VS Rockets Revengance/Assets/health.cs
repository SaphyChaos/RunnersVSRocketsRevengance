...
public class health : MonoBehaviour
{
    ...
    void Update()
    {
        if (hitting && !dead)
        {
            ...
            myProtag.GetComponent<charControl>().canControl = false;
            counter += 1f;
            ...
            if (counter >= stunTime)
            {
                ...
                hitting = false;
                counter = 0;
                myProtag.GetComponent<charControl>().canControl = true;
                invincible = true;
            }
        }
        if (invincible && !dead)
        {
            ...
            if (counter % 3 == 0 || counter % 4 == 0 || counter % 5 == 0 || counter % 7 == 0)
                m_SpriteRenderer.color = new Vector4(1f,1f,1f,.5f);
            else
                m_SpriteRenderer.color = new Vector4(1f, 1f, 1f, 1f);
            if (counter >= iFrames)
            {
                invincible = false;
                counter = 0;
